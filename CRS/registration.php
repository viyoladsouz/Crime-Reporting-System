...
background-image: linear-gradient(rgba(4,9,30,0.7),rgba(4,9,30,0.7)), url(regi_bg.jpeg);
...
<div class="video" style="margin-top: 5%"> 
	<div class="center-container">
		 <div class="bg-agile">
          ...
          <p style="color:#dfdfdf">Password</p><input type="password"  name="password" class="form-control" placeholder="6 Character minimum" pattern=".{6,}" id="pass" onfocusout="f1()"/>
